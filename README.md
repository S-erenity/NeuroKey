...
[Vision sensor capabilities: able to remotly see the robot, allowing for remote retieval of an item.
- 2025-12-9 - Completed sensor test, successfully retrieved item remotly. Started dissasembly of bot.
